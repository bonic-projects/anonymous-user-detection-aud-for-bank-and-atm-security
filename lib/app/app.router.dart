...
import 'package:aud_for_bank/ui/views/home/home_view.dart' as _i2;
import 'package:aud_for_bank/ui/views/notification/notification_view.dart'
    as _i4;
import 'package:aud_for_bank/ui/views/startup/startup_view.dart' as _i3;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i4.NotificationView: (data) {
      final args = data.arguments as NotificationViewArguments?;
      return _i5.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i4.NotificationView(key: args?.key,),
        settings: data,
      );
    },
  };
...
extension NavigatorStateExtension on _i6.NavigationService {
  ...
  Future<dynamic> navigateToNotificationView({
    ...
    return navigateTo<dynamic>(Routes.notificationView,
        arguments: NotificationViewArguments(key: key, arguments:{}),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
