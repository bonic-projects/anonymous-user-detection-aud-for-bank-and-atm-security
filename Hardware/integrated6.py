...
# Load YOLO Model
model = YOLO("best.pt")
TARGET_CLASSES = [0, 1]  # Replace with actual class IDs to detect (e.g., person, weapon, etc.)
CONFIDENCE_THRESHOLD = 0.5  # 70% confidence threshold
...
# Path to Known Faces
KNOWN_FACES_DIR = r"D:\autobonics projects\aud\Threat Detection.v3i.yolov11\images\known_faces"
known_faces = []
known_names = []
...
def process_atm_camera():
    ...
    while True:
        ...
        results = model.predict(source=frame_resized, verbose=False, stream=True)
